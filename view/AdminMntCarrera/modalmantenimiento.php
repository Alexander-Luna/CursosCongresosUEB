        ...
        <div class="modal-content bd-0">
            ...
            <form method="post" id="carrera_form">
                <div class="modal-body">
                    ...
                    <input type="hidden" name="facultad_id" id="facultad_id_input" value="<?php echo $facultad_id; ?>" />
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="form-control-label">Facultad: <span class="tx-danger">*</span></label>
                            <select class="form-control select2" style="width:100%" name="facultad_id" id="facultad_id">
