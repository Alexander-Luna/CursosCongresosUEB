...
<html lang="es">
  <head>
    ...
    <title>Empresa::Facultades</title>
  </head>
  ...
  <body>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          <a class="breadcrumb-item" href="#">facultad</a>
        </nav>
      </div>
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">facultad</h4>
    ...
    <script type="text/javascript" src="adminmntfacultad.js"></script>
  </body>
</html>
<?php
  }else{
