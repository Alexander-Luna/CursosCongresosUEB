    ...
    switch($_GET["op"]){
        ...
        case "guardaryeditar":
            if(empty($_POST["inst_id"])){
                $ponente->insert_ponente($_POST["inst_nom"],$_POST["inst_apep"],$_POST["inst_apem"],$_POST["inst_correo"],$_POST["inst_sex"],$_POST["inst_telf"]);
            }else{
                $ponente->update_ponente($_POST["inst_id"],$_POST["inst_nom"],$_POST["inst_apep"],$_POST["inst_apem"],$_POST["inst_correo"],$_POST["inst_sex"],$_POST["inst_telf"]);
            }
            break;
        /*TODO: Creando Json segun el ID */
        case "mostrar":
            $datos = $ponente->get_ponente_id($_POST["inst_id"]);
        ...
        case "eliminar":
            $ponente->delete_ponente($_POST["inst_id"]);
            break;
        /*TODO:  Listar toda la informacion segun formato de datatable */
        case "listar":
            $datos=$ponente->get_ponente();
            $data= Array();
            foreach($datos as $row){
                $sub_array = array();
